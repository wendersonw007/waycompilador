...
if __name__ == "__main__":
    ...
    def adicionar_origem():
        ...
        ip = entry_ip.get()
        porta = entry_porta.get() or '3306'
        usuario = entry_usuario.get() or 'root'
        senha = entry_senha.get() or 'root'
        
        # Cria um nome amigável para a origem
        nome_amigavel = f"Banco {ip}:{porta}"
    ...
    def adicionar_banco():
        ...
        nome_banco = entry_banco_nome.get()
        
        # Cria um nome amigável para o banco (primeira letra maiúscula)
        nome_amigavel = nome_banco.capitalize()
